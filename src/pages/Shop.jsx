...
// Controls the ORDER collections appear in on the Shop page.
...
// To reorder: just rearrange the lines below.
// To add a new one to a specific position: add its exact Shopify title here.
  ...
  useEffect(() => {
    async function loadCollections() {
      try {
        ...
        const organised = allCollections
          ...
          .sort((a, b) => {
            const aIndex = COLLECTION_ORDER.indexOf(a.title);
            const bIndex = COLLECTION_ORDER.indexOf(b.title);
